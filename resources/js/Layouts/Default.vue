            ...
            >
                ...
                >
                    ...
                    <NavLink href="/" class="flex items-center">
                        <span
                            class="self-center text-xl font-semibold whitespace-nowrap text-[var(--color-primary-base)]"
                            >NLMAF</span
                        >
                    </NavLink>
            ...
            <div class="hidden m-2 mr-4 sm:inline-block"> <!-- This span's purpose is unclear, might be for spacing or a placeholder -->
                    ...
                    >
                        <!-- Adjusted margins for consistency --><span
                            class="mr-2 text-lg text-[var(--color-text-primary)]"
                            ><a href="/user/profile">{{
                                $page.props.auth.user.name
                            }}</a></span
                        >
                        <SecondaryButton @click="handleLogout"
                        ...
                        >
                            ...
                            >
                                <NavLink
                                    ...
                                    class="block py-2 pl-3 pr-4 rounded-sm md:bg-transparent bg-[var(--color-surface-base)] md:p-0 text-[var(--color-text-primary)] transition hover:text-[var(--color-primary-base)]"
                                    aria-current="page"
                                    >{{ link.title }}</NavLink
                                >
                                <span v-else>
                                    <NavLink
                                        ...
                                        class="block py-2 pl-3 pr-4 rounded-sm md:flex md:bg-transparent bg-[var(--color-surface-base)] md:p-0 text-[var(--color-text-primary)] transition hover:text-[var(--color-primary-base)]"
                                    >
                                        {{ link.title }}
                                        <svg
        ...
        >
            <div class="lg:grid lg:grid-cols-8 bg-[var(--color-surface-base)]">
                <div class="relative ml-10 block lg:col-span-3">
                    <img
                        src="/assets/images/Z2sbZpbqstJ980jJ_NLMAF_LOGO_2shues_smallcropped.jpeg"
                    ...
                    <p class="mt-8 text-xs text-[var(--color-text-primary)] sm:mt-0">
                        &copy; 2025. No Limits Martial Arts and Fitness. All
                        rights reserved.
                    </p>
                </div>
                <!-- Content Section -->
                <div class="px-4 py-10 sm:px-6 lg:col-span-2 lg:px-8">
                    <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
                        <div>
                            <p>
                                <span
                                    class="text-xl tracking-wide text-[var(--color-text-primary)] uppercase"
                                >
                                    Contact Us</span
                                >
                                <span
                                    class="block text-xl font-medium text-[var(--color-text-primary)]"
                                    >804-867-5309</span
                                >
                            ...
                            <ul class="mt-8 text-center flex gap-6">
                                <li>
                                    <a
                                        ...
                                        rel="noreferrer"
                                        target="_blank"
                                        class="text-[var(--color-primary-base)] transition hover:opacity-75"
                                    >
                    ...
                    <div>
                        ...
                        <ul class="flex flex-col mt-6 gap-4 text-sm">
                            ...
                            >
                                <NavLink
                                    :href="link.url"
                                    class="text-[var(--color-text-primary)] hover:text-[var(--color-primary-base)]"
                                    >{{ link.title }}</NavLink
                                >
                            </li>
                        </ul>
                    ...
                    <div>
                        <ul class="mt-5 flex flex-row gap-4 ml-10 text-sm">
                            <li>
                                <a
                                    href="#"
                                    class="text-[var(--color-text-primary)] transition hover:opacity-75"
                                >
                                    Terms & Conditions
                                </a>
                            </li>
