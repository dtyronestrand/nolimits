            ...
            >
                <div class="lg:grid lg:grid-cols-8 bg-(--color-primary-500)">
                    <div class="relative ml-10 block lg:col-span-3">
                        ...
                        />
                        <p
                            class="mt-8 text-xs text-(--color-text-primary) sm:mt-0"
                        >
                    ...
                    <div class="px-4 py-10 sm:px-6 lg:col-span-2 lg:px-8">
                        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
                            <div>
                                <p>
                                    <span
                                        class="text-xl tracking-wide text-(--color-text-primary) uppercase"
                                    >
                                        Contact Us</span
                                    >
                                    <span
                                        class="block text-xl font-medium text-(--color-text-primary)"
                                        >804-867-5309</span
                                    >
                                    <PrimaryButton
                                        >Leave a Message</PrimaryButton
                                    >
                                </p>
                        ...
                        <div>
                            <ul class="mt-5 flex flex-row gap-4 ml-10 text-sm">
                                <li>
                                    <a
                                        href="#"
                                        class="text-(--color-text-primary) transition hover:opacity-75"
                                    >
                                        Terms & Conditions
                                    </a>
                                </li>
