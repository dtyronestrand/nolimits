...
<div class="col-span-2"><h1 class="text-7xl text center">Technique Videos</h1></div>
<div class="vid col-span-1" v-for="video in $page.props.videos" :key="video.id">
<a :href="`https://www.youtube.com/embed/${getThumbnail(video.url).videoId}`" target="slider1">
<img :src="`https://img.youtube.com/vi/${getThumbnail(video.url).videoId}/hqdefault.jpg`">
</a>
<p>{{ video.title }}</p>
</div>
<div class="col-span-4 h-auto"><iframe src="" allowfullscreen frameborder="0" name="slider1"></iframe></div>
</div>
