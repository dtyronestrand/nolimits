    ...
    <ActionSection>
        ...
        <template #content>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div
                        class="mt-4 max-w-xl text-sm text-[var(--color-text-primary)]"
                    >
                    ...
                    <div
                        class="mt-4 p-2 inline-block bg-[var(--color-surface-base)]"
                        v-html="qrCode"
                    />
                ...
                <div v-if="recoveryCodes.length > 0 && !confirming">
                    ...
                    <div
                        class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-[var(--color-surface-base)] rounded-lg"
                    >
